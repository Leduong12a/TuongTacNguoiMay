...
const welcomeSlides = [
  {
    ...
    description:
      "Khám phá những tiện ích hỗ trợ làm việc và trò chuyện cùng người thân, bè bạn được tối ưu hoá cho máy tính của bạn.",
    image:
  ...
  },
  {
    ...
    description:
      "Trải nghiệm giao diện tối giúp làm việc ban đêm dễ chịu hơn, bảo vệ thị lực của bạn.",
    image:
  ...
  },
  {
    ...
    description:
      "Dễ dàng tìm lại các tin nhắn cũ, tài liệu, tệp tin PDF quan trạng đã chia sẻ.",
    image:
...
export const Chat: React.FC<ChatProps> = ({ initialContact, onInitialContactConsumed }) => {
      ...
      messages: [
        {
          ...
          text: "Chào anh! Bạn đã có thời gian xem qua văn bản dự thảo Giao diện mà tôi gửi sáng nay chưa?",
          time: "09:15",
        },
        {
          id: "m1_2",
          ...
          text: "Tớ đang xem đây, dự thảo Chương trình của Cộng đồng Học tập thiết kế rất tốt.",
          time: "09:20",
        },
        {
          id: "m1_3",
          senderId: "other",
          senderName: "Lê Quý Dương",
          text: "Rất vui khi bạn thấy hợp. Tôi cũng đã chuẩn bị một vài phương án thay thế cho phần biểu mẫu đăng ký. Tớ gửi kèm file chứng nhận của dự án, cậu check thử xem nhé!",
          time: "09:22",
        },
        {
          id: "m1_4",
          senderId: "me",
          senderName: "Phùng Văn Duy",
          text: "Vâng, cảm ơn anh. Tôi sẽ xem qua trước buổi họp lúc 2 giờ chiều. Chúng ta có thể bàn luận về cách chọn font chữ phù hợp nhất ở phần cài đặt nhé!",
          time: "09:25",
        },
        {
          id: "m1_5",
        ...
        },
        {
          ...
          senderId: "me",
          senderName: "Phùng Văn Duy",
          text: "Tớ đang hoàn thiện nốt phần chiến dịch marketing. Chỉ tầm 30 phút nữa là xong.",
          time: "15:32",
        },
        {
          id: "m1_7",
      ...
      messages: [
        {
          ...
          senderId: "me",
          senderName: "Phùng Văn Duy",
          text: "Tuấn ơi, tài liệu hôm trước cậu gửi ở đâu thế?",
          time: "08:30",
        },
        {
          id: "m2_2",
          ...
          text: "Tớ gửi trong Driver nhóm ấy, cậu check thử đi.",
          time: "08:35",
        },
        {
          id: "m2_3",
          senderId: "me",
          senderName: "Phùng Văn Duy",
          text: "Ok tớ thấy rồi, cảm ơn cậu.",
          time: "08:37",
        },
        {
          id: "m2_4",
          senderId: "other",
          senderName: "Phạm Minh Tuấn",
          text: "Tối nay 8h họp nhóm nhé cậu!",
          time: "09:15",
        },
      ],
    },
      ...
      messages: [
        {
          id: "m3_1",
          senderId: "other",
          senderName: "Lại Anh Đào",
          text: "Mọi người đã chuẩn bị slide báo cáo chưa?",
          time: "Hôm qua 14:10",
        },
        {
          id: "m3_2",
          senderId: "other",
          senderName: "Phạm Ngọc Hách",
          text: "Tớ đang viết nội dung phần 1 và phần 2 rồi.",
          time: "Hôm qua 14:15",
        },
        {
          id: "m3_3",
          senderId: "me",
          senderName: "Phùng Văn Duy",
          text: "Phần code demo tớ cũng hòm hòm rồi nhé.",
          time: "Hôm qua 14:20",
        },
        {
          id: "m3_4",
          senderId: "other",
          senderName: "Đỗ Đình An",
          text: "Tớ vừa cập nhật file figma mới nhất",
          time: "Hôm qua 15:30",
        },
      ],
    },
  ...
  const [expandAutoDelete, setExpandAutoDelete] = useState(false);
  const [autoDeleteOption, setAutoDeleteOption] = useState<
    "off" | "24h" | "7d"
  >("24h");
  const [expandMute, setExpandMute] = useState(false);
  const [muteOption, setMuteOption] = useState<"1h" | "8h" | "24h" | null>(
    null,
  );
  ...
  const mockContacts: Contact[] = [
    ...
    { id: "c4", name: "Phạm Ngọc Sơn", avatar: "NS", avatarBg: "bg-amber-500", status: "Hôm qua", statusColor: "text-slate-400" },
    { id: "c5", name: "Phạm Minh Tuấn", avatar: "MT", avatarBg: "bg-amber-500", status: "Ngoại tuyến", statusColor: "text-slate-400" },
  ...
  const matchingMessages =
    activeThread && messageSearchQuery.trim()
  ...
  const handlePrevResult = () => {
    ...
    const nextIndex =
      (selectedSearchResultIndex - 1 + matchingMessages.length) %
      ...
      <>
        {parts.map((part, i) =>
          regex.test(part) ? (
            <mark
              key={i}
              className="bg-yellow-250 font-bold px-0.5 rounded text-slate-900"
            >
              {part}
            </mark>
          ) : (
  ...
  return (
    <div className="flex-1 flex h-full overflow-hidden bg-white select-none">
            ...
            <div className="px-5 pb-3 border-b border-slate-100 flex flex-col gap-2 shrink-0">
              ...
              {messageSearchQuery.trim() && matchingMessages.length > 0 && (
                <div className="flex items-center justify-between text-[11px] text-slate-500 px-1 pt-1">
                  <span>
                    Kết quả {selectedSearchResultIndex + 1}/
                    {matchingMessages.length}
                  </span>
              ...
              {messageSearchQuery.trim() === "" ? (
                ...
                matchingMessages.map((msg, index) => {
                  ...
                  const senderName = isMe
                    ? "Phùng Văn Duy (Tôi)"
                    : activeThread?.name || "Người dùng";
                  const avatarBg = isMe
                    ? "bg-blue-500"
                    : activeThread?.avatarBg || "bg-slate-400";
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between mb-1.5">
                        <div className="flex items-center gap-2">
                          <div
                            className={`w-6 h-6 rounded-full ${avatarBg} text-white font-bold text-[9px] flex items-center justify-center shrink-0`}
                          >
                            {avatarText}
                          </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3.5 overflow-hidden">
                        {/* Avatar */}
                        <div
                          className={`w-12 h-12 rounded-xl ${thread.avatarBg} text-white font-bold text-[15px] flex items-center justify-center relative shadow-sm shrink-0`}
                        >
                          {thread.avatar}
                          {!thread.isGroup && (
                            <span
                              className={`absolute bottom-[-1.5px] right-[-1.5px] block h-3 w-3 rounded-full ring-[2px] ring-white ${
                        ...
                        <div className="flex flex-col overflow-hidden">
                          <span
                            className={`text-[14.5px] font-bold text-slate-800 truncate ${thread.unreadCount > 0 ? "text-black" : ""}`}
                          >
                            {thread.name}
                          </span>
                          <span
                            className={`text-[12.2px] truncate mt-1 ${
      ...
      {/* ======================================================== */}
      {/* COLUMN 2 (RIGHT): Welcome Carousel OR Message Window + Info Panel */}
      {/* ======================================================== */}
      <div
        className={cn(
          "flex-1 flex flex-row h-full bg-[#F8F9FA] relative overflow-hidden",
          activeThreadId === null && "hidden md:flex",
        )}
      >
        {activeThread ? (
            ...
            <div className="flex-1 flex flex-col h-full overflow-hidden">
              ...
              <div className="h-16 bg-white border-b border-slate-200 px-6 flex items-center justify-between shrink-0 z-10 shadow-sm/50">
                <div className="flex items-center gap-3.5">
                  ...
                  <div
                    className={`w-10.5 h-10.5 rounded-xl ${activeThread.avatarBg} text-white font-bold text-[14.5px] flex items-center justify-center shadow-sm shrink-0`}
                  >
                    {activeThread.avatar}
                  </div>
                  <div className="flex flex-col">
                    <span className="text-[14.8px] font-extrabold text-slate-800">
                      {activeThread.name}
                    </span>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={`p-1.5 rounded-lg hover:bg-slate-100 cursor-pointer focus:outline-none transition-colors ${
                        showOptionsPanel
                    ...
                    >
                      ...
                      <div className="flex items-end gap-2 group">
                        ...
                        >
                          ...
                          {msg.attachment && (
                            <div
                              className={`mt-2 bg-slate-50 border border-slate-200 rounded-lg p-2.5 flex items-center justify-between hover:bg-slate-105 transition-colors text-slate-805`}
                            >
